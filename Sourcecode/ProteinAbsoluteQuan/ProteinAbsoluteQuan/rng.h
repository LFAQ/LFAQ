...
inline ulong fULONG32(slong x) { return (ulong(x)); }
inline ulong fULONG32(ulong x) { return (ulong(x)); }
inline ulong fULONG32(double x) { return (ulong(x)); }
inline slong UL32toSL32(ulong x) { return (slong(x)); }
#else
inline ulong fULONG32(slong x) { return (ulong(x) & 0xfffffffful); }
inline ulong fULONG32(ulong x) { return (x & 0xfffffffful); }
inline ulong fULONG32(double x) { return (ulong(x) & 0xfffffffful); }
