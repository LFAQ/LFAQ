...
x<-d[d$ExperiemntName=="UPS2_yeast","SpikedInMols"];
LFAQ<-d[d$ExperiemntName=="UPS2_yeast","LFAQ"];
LLFAQ<-rep("LFAQ",length(LFAQ))
plotFrame<-data.frame(SpikedIn=x,Label=LLFAQ,LFAQ=LFAQ)
tiff(file="G:\\InHouseSourceCode\\LFAQ\\LFAQGUI\\LFAQ\\bin\\x86\\Release/LFAQOfStandPro.tiff",res=500,width=2000,height=1500,compression = "lzw")
